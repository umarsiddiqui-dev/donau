      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center fade-up" ref={addToRefs}>
          <h1 className="text-4xl md:text-5xl lg:text-[3.6rem] font-extrabold leading-tight tracking-tight text-dark-900">
            Build products without<br />managing supply chains.
          </h1>
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-4">
            <button 
              ...
              className="btn-primary bg-[#3F8AE2] text-white font-semibold px-7 py-3 rounded-lg text-sm shadow-lg shadow-blue-100"
            >
              Create Product
            </button>
            <button 
              onClick={() => openModal('demo')}
              className="btn-outline border border-gray-200 bg-white text-gray-700 font-semibold px-7 py-3 rounded-lg text-sm"
            >
              View Demo
            </button>
          </div>
      ...
      <section className="py-24 px-6 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center mb-16 fade-up" ref={addToRefs}>
          ...
          <p className="mt-4 text-gray-500 text-lg">
            Define your product requirements clearly with AI assistance and get matched with the right manufacturers faster.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100 fade-up" ref={addToRefs}>
          ...
          <div className="px-8 py-6 border-b border-gray-100 mb-2 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="flex items-center justify-center relative w-9 h-9">
                <svg className="w-full h-full text-primary-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
              ...
              <span className="font-bold text-dark-900 tracking-tighter text-lg">Donau AI Assistant</span>
            </div>
          </div>
          ...
          <div className="p-8 pt-4 space-y-8">
            <div className="flex justify-end">
              <div className="bg-[#3F8AE2] text-white px-7 py-5 max-w-md rounded-2xl rounded-tr-none shadow-sm">
                <p className="text-[14px] leading-relaxed font-semibold">
                  Create a premium Vitamin D3 supplement for the European market. Capsules, bottle packaging, MOQ around 5,000 units.
                </p>
              </div>
            </div>
            
            <div className="flex justify-start">
              <div className="bg-[#EFF6FC] rounded-2xl rounded-tl-none px-8 py-7 max-w-xl text-dark-800 border border-blue-50/50 shadow-sm">
                ...
                <div className="mt-8">
                  <p className="text-[14px] mb-4 font-bold text-dark-900">Estimated next steps:</p>
                  <ul className="text-[14px] space-y-3 text-dark-800 font-medium">
                    <li className="flex gap-2"><span>•</span> Finalize formulation details</li>
                    <li className="flex gap-2"><span>•</span> Send structured brief to verified manufacturers</li>
                    <li className="flex gap-2"><span>•</span> Receive offers within 48 hours.</li>
                  </ul>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-center gap-3">
                <div className="relative flex-1">
                  <input 
                    ...
                    className="w-full px-6 py-3.5 bg-[#F8FAFC] border border-gray-100 rounded-xl outline-none transition-all duration-300 text-[14px] text-gray-400" 
                    readOnly
                  />
                </div>
                <button className="w-12 h-12 bg-[#3F8AE2] rounded-xl flex items-center justify-center text-white hover:bg-[#3577C8] transition shadow-sm">
      ...
      <section className="py-24 px-6 bg-gray-50">
        <div className="max-w-3xl mx-auto text-center fade-up" ref={addToRefs}>
          ...
          <div className="mt-10">
            <button 
              onClick={() => openModal('signup')}
              className="btn-primary bg-[#3F8AE2] text-white font-bold px-10 py-4 rounded-xl shadow-xl shadow-blue-100"
            >
              Create Product
            </button>
          </div>
