  ...
  return (
    <div className="bg-white">
      <main className="max-w-4xl mx-auto px-6 py-24">
        <h1 className="text-5xl font-extrabold text-dark-900 mb-4 tracking-tight">Privacy Policy</h1>
        <p className="text-gray-400 font-medium mb-12">Last updated: February 9, 2026</p>

        <div className="legal-content">
          <h2 className="text-2xl font-extrabold text-dark-900 mt-10 mb-5">1. Introduction</h2>
          <p className="text-[0.95rem] leading-[1.7] text-slate-500 mb-5">Donau ("we", "us", "our") operates the donau platform. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our service.</p>
          ...
          <p className="text-[0.95rem] leading-[1.7] text-slate-500 mb-5">We do not sell your personal data. We may share information with manufacturers only as necessary to facilitate the matching and proposal process, and only with your consent. We may also share data with service providers who assist us in operating the platform.</p>

          <h2 className="text-2xl font-extrabold text-dark-900 mt-10 mb-5">5. Data Security</h2>
          <p className="text-[0.95rem] leading-[1.7] text-slate-500 mb-5">We implement appropriate technical and organizational measures to protect your personal data against unauthorized access, alteration, disclosure, or destruction.</p>

          <h2 className="text-2xl font-extrabold text-dark-900 mt-10 mb-5">6. Data Retention</h2>
          <p className="text-[0.95rem] leading-[1.7] text-slate-500 mb-5">We retain your personal data only for as long as necessary to fulfill the purposes outlined in this policy, unless a longer retention period is required by law.</p>
          ...
          <p className="text-[0.95rem] leading-[1.7] text-slate-500 mb-5">We use essential cookies to operate the platform and analytics cookies to understand usage patterns. You can manage cookie preferences through your browser settings.</p>

          <h2 className="text-2xl font-extrabold text-dark-900 mt-10 mb-5">9. Changes to This Policy</h2>
